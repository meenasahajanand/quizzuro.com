...
const GA_MEASUREMENT_ID = "G-PYMCRXLD53";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17813866460/CPcxCMnewdMbENyPqK5C",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/quizzuro.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/quizzuro.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/quizzuro.com_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/quizzuro.com_reward",
